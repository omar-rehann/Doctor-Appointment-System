  ...
  our top priority.
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
                                <li>
                          <Link href="/fetures/User/Homepage"   className="font-bold me-2 text-md hover:text-blue-700 transition-colors duration-300 ease-in-out"><i className="fa-solid fa-house me-2"></i>
  Home Page</Link>
                    </li>
                    <li>
                          <Link href="/fetures/User/aboutpage"   className="font-bold me-2 text-md hover:text-blue-700 transition-colors duration-300 ease-in-out"
> <i className="fa-solid fa-circle-info me-2"></i>
  About Us</Link>
                    </li>
                       <li>
                          <Link href="/fetures/User/allservicepage"   className="font-bold me-2 text-md hover:text-blue-700 transition-colors duration-300 ease-in-out"
> <i className="fa-solid fa-stethoscope me-2"></i>
  All Services</Link>
                    </li>
                       <li>
                          <Link href="/fetures/User/allapointemnt"   className="font-bold me-2 text-md hover:text-blue-700 transition-colors duration-300 ease-in-out"
>  <i className="fa-solid fa-calendar-check me-2"></i>
  All Appointment</Link>
                    </li>
                       <li>
                          <Link href="/fetures/User/contactpage"   className="font-bold me-2 text-md hover:text-blue-700 transition-colors duration-300 ease-in-out"
